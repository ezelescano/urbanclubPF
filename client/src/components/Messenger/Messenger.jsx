    ...
    <div className="messenger">
        ...
        <div className="chatBoxWrapper">
          ...
          <>
            ...
            <div className="chatBoxBottom">
              <button onClick={() => setShowPicker(!showPicker)}><SentimentVerySatisfiedIcon/></button>
      ...
      <div className="chatOnline">
        <div className="chatOnlineWrapper">
          <ChatOnline onlineUser={onlineUser} currentId={user.id} setCurrentChat={setCurrentChat}/>
        </div>
      </div>
    </div>
  )
