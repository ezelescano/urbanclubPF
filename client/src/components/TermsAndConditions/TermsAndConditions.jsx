    ...
    <div className={styles.termsContainer}>
      ...
      <div className={styles.termsContent}>
        ...
        <h1>
          ...
          precisa y actualizada. Eres responsable de mantener la
          confidencialidad de tu cuenta y contraseña, y aceptas ser responsable
        ...
        <h1>
          ...
          Estos enlaces se proporcionan para tu conveniencia y para proporcionar
